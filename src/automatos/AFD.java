...
public class AFD {
	...
	/**
	 * M�todo construtor de um Aut�mato finito determin�stico
	 * 
	 * @param simbolos
	 *            ConjuntoSimbolo que representa o alfabeto do aut�mato finito
	 *            determin�stico
	 * @param estados
	 *            ConjuntoEstados que representa o conjunto de estados do
	 *            aut�mato finito determin�stico
	 * @param funcaoPrograma
	 *            ConjuntoTransicaoD que representa a fun��o programa do
	 *            aut�mato finito determin�stico
	 * @param estadoInicial
	 *            Estado que representa o estado inicial do aut�mato finito
	 *            determin�stico
	 * @param estadosFinais
	 ...
	 * 
	 * @param simbolos
	 *            um ConjuntoSimbolo a ser definido como o alfabeto do automato
	...
	/**
	 * Cria e retorna uma copia do objeto AFD
	 * 
	...
	/**
	 * Nesse metodo esta implemtado o algoritmo para geracao de L(M), sendo M um
	 * AFD
	 */
	...
	* @return estado alcan�ado depois de processar a palavra p a partir de um estados e 
	* @param Estado Estado onde iniciar� o processamento
	...
	*/
	public Estado pe (Estado e, String p){
		if (p.isEmpty())
                    ...
                    Estado tmp = p(e,new Simbolo(p.charAt(0)));
                    if (tmp!=null)
                        return pe(tmp,p.substring(1));
                    else // transicao invalida
                        return null;
                }
	}
	/*
	* Retorna se uma palavra eh aceita ou nao por determinado AFD
	* @return true caso a palavra eh aceita; false caso contrario 
	...
	*/
	 ...
	 * @param filename Nome do arquivo XML que será criado sem a extensao.
	 */
